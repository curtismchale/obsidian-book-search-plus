...
* **UI:** On 429, keep the search modal open and show an actionable notice — tells the user to wait, and prompts them to add a Google Books API key in Settings if they don't have one.
